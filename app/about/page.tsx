  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-20 lg:px-8 lg:py-28">
      ...
      <section>
        ...
        <h1 className="mt-5 text-5xl font-semibold tracking-[-0.04em] text-neutral-950 sm:text-6xl">
          Hey, I'm Vansh.
        </h1>
      ...
      <section className="mt-24 border-t border-neutral-200 pt-12">
        ...
        <div className="mt-6 max-w-3xl space-y-5 text-lg leading-8 text-neutral-600">
          ...
          <p>
            ...
            databases, distributed systems, and other engineering topics that I
            find interesting.
          </p>
        </div>
      </section>
      ...
      <section className="mt-24 border-t border-neutral-200 pt-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div
              key={item.title}
              className="rounded-2xl border border-neutral-200 p-6 transition hover:border-neutral-300 hover:bg-neutral-50"
            >
      ...
      <section className="mt-24 border-t border-neutral-200 pt-12">
        ...
        <div className="mt-6">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-neutral-600">
            I work across backend systems, production infrastructure, real-time
            applications, IoT platforms, and AI-powered workflows. A lot of my
            work involves figuring out how individual components can work
            reliably together as a system.
          </p>
        </div>
      </section>
      ...
      <section className="mt-24 border-t border-neutral-200 pt-12">
        ...
        <div className="mt-6">
          ...
          <p className="mt-4 text-neutral-600">CGPA: 8.8 / 10</p>
        </div>
      </section>
      ...
      <section className="mt-24 border-t border-neutral-200 pt-12">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a
            ...
            className="rounded-full border border-neutral-200 px-5 py-2.5 text-sm font-medium text-neutral-700 transition hover:border-neutral-300 hover:bg-neutral-50"
          >
            GitHub
          </a>
